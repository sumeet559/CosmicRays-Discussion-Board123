...
public class ValidateName extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
		//Person p1 = new Person(1, "vishal", "gupta", "pune@gmail.com", "123456");
		String got_value = request.getParameter("username");
		boolean passed = validateName(got_value);
	...
	private boolean validateName(String name) throws SQLException{
			Connection dbConnection = null;
			//PreparedStatement preparedStatementselect = null;
			ResultSet rs1 = null;
			boolean rev = true;
			String selectSQL = "Select * from approve_user where USER_NAME='" + name +"'" ;
